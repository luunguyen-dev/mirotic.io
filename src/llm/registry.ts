...
export const MODELS: Record<string, ModelMeta> = {
  ...
  "gemini-2.5-pro":             { name: "gemini-2.5-pro",              tier: "text",    cost_in: 1.25, cost_out: 5 },
  "gemini-3.5-flash":           { name: "gemini-3.5-flash",            tier: "text",    cost_in: 0.1,  cost_out: 0.4 },
...
export const AGENTIC_PRIORITY: Record<ComplexityClass, string[]> = {
  complex: ["claude-opus-4-8", "claude-sonnet-5", "gpt-5.5"],
